...
Betreten Nutzer die Hauptseite der Website, so können sie ihren Nutzernamen eingeben, dem Matchmaking beitreten oder direkt einem Match über die Room-ID des Matches beitreten.
...
\subsubsection{Room}
Rooms stellen die eigentlichen Spielinstanzen des Spiels dar.
...
\begin{description}
	...
	\fn{0160}{Maximalanzahl an Players}
